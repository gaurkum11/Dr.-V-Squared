...
from doctor_voice import text_to_speech_with_elevenlabs,text_to_speech_wth_gtts
...
def process_inputs(audio_file_path, image_filepath):
    speech_to_text_output = transcribe_with_groq(stt_model="whisper-large-v3",audio_file_path=audio_file_path,GROQ_API_KEY=os.environ.get("GROQ_API_KEY"))
    ...
    voice_of_doctor = text_to_speech_wth_gtts(input_text=doctor_response, output_file_path="final.mp3") 
